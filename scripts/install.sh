...
case $answer in
1)
  packages=("zip" "openrgb" "fish" "unzip" "wget" "curl" "neovim" "lazygit" "eza" "fastfetch" "btop" "gamemode" "torbrowser-launcher" "mangohud" "zoxide" "fzf" "bat" "kitty")
...
2)
  packages=("zip" "openrgb" "fish" "unzip" "wget" "curl" "neovim" "torbrowser-launcher" "lazygit" "eza" "fastfetch" "btop" "gamemode" "mangohud" "zoxide" "fzf" "bat" "kitty")
...
3)
  packages=("zip" "fish" "gcc" "openrgb" "unzip" "wget" "curl" "neovim" "lazygit" "eza" "fastfetch" "btop" "torbrowser-launcher" "gamemode" "mangohud" "zoxide" "fzf" "bat" "discord" "steam" "kitty")
